export const en = {
  ...
  descriptionPlaceholder: "Provide information about this run",
  ...
  missingParticipantsSubtitle: "Be the first to sign up to this run",
  missingRunsTitle: "No runs were found",
  missingRunsSubtitle: "Get started by creating a run",
  missingPastRunsTitle: "No runs were found",
  missingPastRunsSubtitle: "Get started by signing up to a run",
  missingScheduledRunsTitle: "No runs were found",
  missingScheduledRunsSubtitle: "Get started by signing up to a run",
